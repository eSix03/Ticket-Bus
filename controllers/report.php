...
//        $this->view->js_2 = array('public/js/map/parse-1.2.18.min.js');
    ...
    function bookerReport() {
        ...
        $table_f = '';
        //++++++++++++++++++++++++++++++++++++++++++++
        $report_h = '<H3>Información De Reserva</H3><H5> Numero De Bus : ' . $busNo . '</H5><H5> Fecha De Viaje : ' . $journeyDate . '</H5>';
        $table_h = '<table ellpadding="0" cellspacing="0" rules="all" border="0"  width="*0%" align="center">
                    <hr/><tr> 
                        <th align="center" width="50px"></th>
                        <th align="center" width="170px" >ID</th>
                        <th align="center" width="120px">No. Reservador NIC</th>
                        <th align="center" width="120px">Nombre De Reservador</th>
                        <th align="center" width="100px">Entrada</th>
                        <th align="center" width="50px">Numero De Asiento</th>
                        <th align="center" width="75px">Valor</th>
                        <th align="center" width="100px">No. Movil</th>
                    </tr><hr/>
                    ';
    ...
    function passengerReport() {        //print_r($this->model->getPassengerData($_POST['journeyDate'],$_POST['busNo']));
        ...
        $table_b = '';
        $table_f = '';
        $report_h = '<H1></H1><H3>Informacion Del Pasajero</H3><H5> Numero De Bus : ' . $busNo . '</H5><H5> Fecha De Viaje : ' . $journeyDate . '</H5>';
        $table_h = '<table ellpadding="0" cellspacing="0" rules="all"  width="80%" align="center">
                    <hr/><tr> 
                        <th align="center" width="30px"></th>
                        <th align="center" width="50px" >No Asiento</th>
                        <th align="center" width="160px">No Ticket</th>
                        <th align="center" width="180px">Nombre Pasajero</th>
                        <th align="center" width="50px">Genero</th>
    ...
    function searchAllBookingData($formDate, $toDate) {
        $report_h = '<H3> Reporte De Reserva</H3><H4> Fecha Del ' . $formDate . ' al ' . $toDate . '</H4>';
        $table_h = '<table ellpadding="0" cellspacing="0" rules="all"  width="80%" align="center">
                    <hr/><tr> 
                        <th align="center" width="100px"></th>
                        <th align="center" width="120px"><H4>Numero De Bus</H4></th>
                        <th align="center" width="120px"><H4>Viaje No</H4></th>
                        <th align="center" width="100px"><H4># De Asiento</H4></th>
                        <th align="right" width="120px"><H4>Valor</H4></th>
                        </tr><hr/>
                    ';
        $table_b = '';
        $total_ammount = 0.00;
    ...
    function searchBookingData($formDate, $toDate, $busNo, $journeyNo) {
        $report_h = '<H3> Reporte De Reserva</H3><H4> Numero De Bus : ' . $busNo . ' - Viaje No : ' . $journeyNo . '</H4><H4> Fecha Del ' . $formDate . ' al ' . $toDate . '</H4>';
        $table_h = '<table ellpadding="0" cellspacing="0" rules="all"  width="80%" align="center">
                    <hr/><tr> 
                        <th align="center" width="100px"></th>
                        <th align="center" width="120px"><H4>Numero De Bus</H4></th>
                        <th align="center" width="120px"><H4>Viaje No</H4></th>
                        <th align="center" width="80px"><H4># De Asiento</H4></th>
                        <th align="right" width="80px"><H4>Valor</H4></th>
    ...
    function searchAllBusBookingData($formDate, $toDate, $busNo) {
        $report_h = '<H3> Reporte De Reserva</H3><H4> Numero De Bus : ' . $busNo . '</H4><H4> Fecha Del ' . $formDate . ' al ' . $toDate . '</H4>';
        $table_h = '<table ellpadding="0" cellspacing="0" rules="all"  width="80%" align="center">
                    <hr/><tr> 
                        <th align="center" width="100px"></th>
                        <th align="center" width="120px"><H4>Numero De Bus</H4></th>
    ...
    function searchAllJourneyBookingData($formDate, $toDate, $journeyNo) {
        $report_h = '<H3> Reporte De Reserva</H3><H4> Viaje No : ' . $journeyNo . '</H4><H4> Fecha Del ' . $formDate . ' al ' . $toDate . '</H4>';
        $table_h = '<table ellpadding="0" cellspacing="0" rules="all"  width="80%" align="center">
                    <hr/><tr> 
                        <th align="center" width="100px"></th>
                        <th align="center" width="120px"><H4>Numero De Bus</H4></th>
                        <th align="center" width="120px"><H4>Viaje No</H4></th>
                        <th align="center" width="80px"><H4>Numero De Asiento</H4></th>
                        <th align="right" width="80px"><H4>Valor</H4></th>
                        <th align="center" width="120px"><H4>Fecha----------------------------------------------------------------------------------------------------------</H4></th>
                        </tr><hr/>
                    ';
        $table_b = '';
        $no_of_seat = 0;
    ...
    function bookingReportforPDF() {
        if (isset($_POST['busNo'])) {
            ...
            $busNo = $_POST['busNo'];
            $journeyNo = $_POST['journeyNo'];
            $report_h = '<H3> Reporte De Reserva</H3><H4> Journey Date : ' . $journeyDate . '</H4>';
            $table_h = '<table>
                            <hr/>
                            <tr>
