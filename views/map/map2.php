...
<script type="text/javascript">
    ...
    var latlog = new google.maps.LatLng(-1.8106000517108145, -79.54409087467779);//7.9000,80.7000 6.9000,79.8700
    var mapOptions = {
        center: latlog,
        zoom: 12 //9
    };
...
<div id="map-key">
    ...
    <img src="<?php echo URL; ?>public/images/map/bus-green-icon.png"> Corriendo Bus <br/><br/>
    <img src="<?php echo URL; ?>public/images/map/bus-yellow-icon.png"> Esperando el autobús <br/><br/>
    <img src="<?php echo URL; ?>public/images/map/bus-red-icon.png"> Bus de avería <br/>
</div>
