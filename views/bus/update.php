...
<div class="main-form">
    <h1 class="titulos">Editar Bus</h1>
    <?php
    ...
    <form id="bus_update_form" action="<?php echo URL; ?>bus/updateBus/" method="post">
        ...
        <label for="Bus_busNo" class="required">No De Bus</label>
    ...
    ?>" id="uBus_busNo" type="text"  data-validation="required" ><br />			
        ...
        <label for="Bus_busModel" class="required">Modelo De Bus</label>
        ...
        <label for="Bus_numberOfSeat" class="required">Numero De Asiento</label>
