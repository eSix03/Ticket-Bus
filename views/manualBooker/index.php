    ...
    <div id="about_panel">
        ...
        <div id="busViews">
            ...
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="274" height="40" align="left" valign="middle"><span class="tx3">Proveedor de servicios : </span>&nbsp;</td>
                    <td colspan="2" align="left" valign="middle"><span class="tx3">Viajando desde  :</span> &nbsp;COLOMBO&nbsp;&nbsp;<span class="tx3">A  :</span>&nbsp;&nbsp;JAFFNA</td>
                </tr>
                <tr>
                    <td height="40" align="left" valign="middle"><span class="tx3"> Fecha de viaje
 :</span>
                        2014-03-04</td>
                    <td width="177" align="left" valign="middle"><span class="tx3">Billete de autobús : </span>&nbsp;
                        Rs 1350.00</td>
                    <td width="149" align="left" valign="middle"><span class="tx3">Tipo de bus : </span>&nbsp;TATA GLOBUS</td>
                </tr>
