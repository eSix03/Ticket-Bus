...
<h1 class="titulos">Detalles De Reserva</h1>
...
<form id="" action="<?php echo URL; ?>bookingSeat/manualBookerConform/" method="post">
    ...
    <h3 style ="margin-bottom:10px; margin-top:10px">Detalles del Reservador</h3>
    <div id="booker_info">
        <div>
            ...
            <select name="boardpoint" class="" id="onboardpoint" data-validation="required" style="width: 200px; height: 25px;">
                <option value="">Seleccione el punto de embarque</option>
                <?php
