...
<div class="">
    <div id="bodyhead"><h1 class="titulos">Punto de entrada para el viaje</h1></div>
    <?php
...
//                        print_r($this->searchEntryPointForJourney);
                            foreach ($this->searchEntryPointForJourney as $key => $value) {
                                ...
                                echo '<td>
                            <a href="' . URL . 'journey/deleteEntryPointForJourney/' . $value['entryPoint_for_journeyNo'] . '/' . $value['journeyNo'] . '"><img class="table-delete-button" alt=""/></a>
                        </td>';
                                echo '</tr>';
                            }
                        }
        ...
        <div class="tFotm">
            <form id="EntryPointForJourney_create_form" action="<?php echo URL; ?>journey/addEntryPointForJourney/" method="post">
                <label for="enntryPoint" class="required">Punto de entrada</label>
                <?php
